...
public class BookController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
              ...
              String day = request.getParameter("mday");
             String mdate = request.getParameter("mdate");
            String seat = request.getParameter("seats");
            String prices = request.getParameter("prices");

           // System.out.println("@@@@@@@@@After book" +muvi+" "+time+" "+day);
		String seats[] = seat.split(",");
                //String price[] = prices.split(",");
		SeatInfo update = new SeatInfo();
		update.updateSeats(seats);
		response.sendRedirect("final.jsp?seats= "+seat+"&mname="+muvi+"&mtime="+time+"&mday="+day+"&price="+prices+"&mdate="+mdate+"&uid="+uid);
